...
import type { DateRangePickerPartContext, DateRangePickerParts } from '../../parts'
...
const { unstyled: resolvedUnstyled } = useClvComponent<DateRangePickerPartContext>(
  'date-range-picker',
  props,
)
</script>
